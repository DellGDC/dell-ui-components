...
=======
height:b?a("div.dataTables_scroll",this.s.dt.nTableWrapper).height():a(this.s.dt.nTable).height()}).appendTo("body")},_fnDestroy:function(){var b,c;for(b=0,c=this.s.dt.aoDrawCallback.length;c>b;b++)if("ColReorder_Pre"===this.s.dt.aoDrawCallback[b].sName){this.s.dt.aoDrawCallback.splice(b,1);break}a(this.s.dt.nTHead).find("*").off(".ColReorder"),a.each(this.s.dt.aoColumns,function(b,c){a(c.nTh).removeAttr("data-column-index")}),this.s=this.s.dt._colReorder=null},_fnSetColumnIndexes:function(){a.each(this.s.dt.aoColumns,function(b,c){a(c.nTh).attr("data-column-index",b)})}},g.defaults={aiOrder:null,bRealtime:!1,iFixedColumns:0,iFixedColumnsRight:0,fnReorderCallback:null},g.version="1.1.3",a.fn.dataTable.ColReorder=g,a.fn.DataTable.ColReorder=g,"function"==typeof a.fn.dataTable&&"function"==typeof a.fn.dataTableExt.fnVersionCheck&&a.fn.dataTableExt.fnVersionCheck("1.9.3")?a.fn.dataTableExt.aoFeatures.push({fnInit:function(a){var b=a.oInstance;return a._colReorder?b.oApi._fnLog(a,1,"ColReorder attempted to initialise twice. Ignoring second"):(b=a.oInit,new g(a,b.colReorder||b.oColReorder||{})),null},cFeature:"R",sFeature:"ColReorder"}):alert("Warning: ColReorder requires DataTables 1.9.3 or greater - www.datatables.net/download"),a.fn.dataTable.Api&&(a.fn.dataTable.Api.register("colReorder.reset()",function(){return this.iterator("table",function(a){a._colReorder.fnReset()})}),a.fn.dataTable.Api.register("colReorder.order()",function(a){return a?this.iterator("table",function(b){b._colReorder.fnOrder(a)}):this.context.length?this.context[0]._colReorder.fnOrder():null})),g},"function"==typeof define&&define.amd?define(["jquery","datatables"],a):"object"==typeof exports?a(require("jquery"),require("datatables")):jQuery&&!jQuery.fn.dataTable.ColReorder&&a(jQuery,jQuery.fn.dataTable)}(window,document),angular.module("dellUiComponents",[]),angular.module("dellUiComponents").config(function(){}).run(["$rootScope",function(a){function b(){var b=$(window).width();switch(a.bp={isXS:!1,isSM:!1,isMD:!1,isLG:!1},!0){case 750>b:a.bp.isXS=!0;break;case b>751&&975>b:a.bp.isSM=!0;break;case b>974&&1141>b:a.bp.isMD=!0;break;default:a.bp.isLG=!0}}a.safeApply=function(b){var c=a.$$phase;"$apply"===c||"$digest"===c?b&&"function"==typeof b&&b():this.$apply(b)},b(),$(window).resize(function(){b(),a.safeApply()})}]),function(a){a.dellUIoverflowTab=function(b,c){var d=this;d.$el=a(b),d.el=b,d.$el.data("dellUIoverflowTab",d)},a.dellUIoverflowTab.defaultOptions={defaultHeight:42,pagerWidth:29,xsMax:750,smMin:751,smMax:975,mdMin:974,mdMax:1141,iconClasses:{left:"glyphicon glyphicon-menu-left",right:"glyphicon glyphicon-menu-right"}},a.fn.dellUIoverflowTab=function(b){return b&&(a.dellUIoverflowTab.defaultOptions=a.extend(a.dellUIoverflowTab.defaultOptions,b)),this.each(function(){new a.dellUIoverflowTab(this);var b,c,d=a.dellUIoverflowTab.defaultOptions,e=a(this),f=e.parent().width(),g=e.find("> li"),h=[],i=0,j=d.pagerWidth,k=d.pagerWidth,l=d.pagerWidth,m=!1,n={},o=d.defaultHeight,p=function(){var b=a(window).width(),c={isXS:!1,isSM:!1,isMD:!1,isLG:!1};switch(!0){case b<d.xsMax:c.isXS=!0;break;case b>d.smMin&&b<d.smMax:c.isSM=!0;break;case b>d.mdMin&&b<d.mdMax:c.isMD=!0;break;default:c.isLG=!0}return c},q=!1,r=function(){_.each(g,function(b,c){i=i+a(b).width()+1;var d={index:c,offset:k,width:a(b).width(),height:a(b).height(),visibility:1};g.length===c+1||(k=k-d.width-1),d.height>o&&(o=d.height),h.push(d)}),n=h[0],q=i>f},s=function(a,c){var d,g=1;a&&(g=-1),l=parseInt(e.css("left")),n||(n=h[0]),m=j===l,a?n.visibility=1:n.visibility=0,n=h[n.index+g],b=_.reduce(_.pluck(_.filter(h,function(a){return 1===a.visibility}),"width"),function(a,b){return a+b},0),d?d=!1:c?c.lastTab&&(d=!0):d=f>b,n?(d?(l=f-i-j,e.parent().find("> .next").addClass("disabled")):(e.parent().find("> .next").removeClass("disabled"),l=n.offset),c&&!d&&c.index!==h.length-1&&(l=c.tabContainerWidth-c.rightMostPoint-60),p().isXS||e.css("left",l+"px")):m=!0,m?e.parent().find("> .prev").addClass("disabled"):e.parent().find("> .prev").removeClass("disabled")};r(),q&&(e.width(i+1),e.css("left",j+"px"),e.parent().addClass("nav-tabs-overflow-container"),e.before('<div class="prev disabled"><a href="javascript:;"><i class="'+d.iconClasses.left+'"></i></a></div>'),e.after('<div class="next"><a href="javascript:;"><i class="'+d.iconClasses.right+'"></i></a></div>'),c=function(a){a?(e.css("height",a+2+"px"),e.find("> li").find("a").css("height",a+"px"),e.parent().find(".prev,.next").find("a").css("height",a+"px"),e.parent().find(".prev,.next").find("a").css("padding-top",a/2-8+"px")):(e.removeAttr("style").width(i+200),e.find("> li").find("a").removeAttr("style"),e.parent().find(".prev,.next").find("a").removeAttr("style"))},o>d.defaultHeight&&!p().isXS?c(o):c(),a(window).resize(function(){p().isXS?c():c(o)}),g.on("click",function(b){var c={rightMostPoint:b.currentTarget.offsetLeft+b.currentTarget.offsetWidth,leftMostPoint:b.currentTarget.offsetLeft+b.currentTarget.offsetWidth-a(b.currentTarget).width()-2,tabContainerWidth:a(b.currentTarget).parents(".nav-tabs-overflow-container").width(),tabContainerOffset:a(b.currentTarget).parent()[0].offsetLeft,index:a(b.currentTarget).index()};c.tabContainerWidth-c.rightMostPoint-c.tabContainerOffset<d.pagerWidth+1?c.index===h.length-1?c.rightMostPoint+c.tabContainerOffset+d.pagerWidth-1<c.tabContainerWidth?s(!1,c):c.rightMostPoint+c.tabContainerOffset+d.pagerWidth-1>c.tabContainerWidth&&(c.lastTab=!0,s(!1,c)):s(!1,c):c.leftMostPoint+c.tabContainerOffset<0&&s(!0)}),e.parent().find("> .prev").on("click",function(b){a(b.currentTarget).hasClass("disabled")||s(!0)}),e.parent().find("> .next").on("click",function(b){a(b.currentTarget).hasClass("disabled")||s()}))})}}(jQuery),function(a){a.dellUIloadMore=function(b,c){var d=this;d.$el=a(b),d.el=b,d.$el.data("dellUIloadMore",d)},a.dellUIloadMore.defaultOptions={lazyLoad:!1,scrollTarget:window,fadeIn:!0,loadMoreButtonText:"Load more",loadMoreIncrement:5},a.fn.dellUIloadMore=function(b){return b&&(a.dellUIloadMore.defaultOptions=a.extend(a.dellUIloadMore.defaultOptions,b)),this.each(function(){new a.dellUIloadMore(this);var b=a.dellUIloadMore.defaultOptions,c=a(this),d=0,e=c.find("li"),f="undefined"!=typeof a(this).attr("id")?a(this).attr("id"):Math.random(1+1e11*Math.random()),g='<p><button id="load-more-button-'+f+'" rel="'+f+'" type="button" class="btn btn-block">'+b.loadMoreButtonText+"</button></p>",h=function(){d+=b.loadMoreIncrement,e=c.find("li"),e.each(function(b){d>b&&a(e[b]).is(":hidden")&&(a(this).addClass("in"),b+1===e.length&&a("#load-more-button-"+f).remove())})},i=function(){c.hasClass("load-more-lazy")&&(b.lazyLoad=!0),b.fadeIn&&e.addClass("fade"),h(),b.lazyLoad?b.scrollTarget===window?a(b.scrollTarget).scroll(function(){a(b.scrollTarget).scrollTop()+a(b.scrollTarget).height()===a(document).height()&&h()}):a(b.scrollTarget).scroll(function(){a(this).scrollTop()+a(this).height()===a(this)[0].scrollHeight&&h()}):(c.after(g),a("#load-more-button-"+f).click(function(){h()}))};i()})}}(jQuery),function(a){a.dellUIcontentGallery=function(b){var c=this;c.$el=a(b),c.el=b,c.$el.data("dellUIcontentGallery",c)},a.fn.dellUIcontentGallery=function(){return this.each(function(){new a.dellUIcontentGallery(this);var b=a(this),c=b.find("li"),d=b.find(".content-gallery-show-more"),e=function(){d.on("click",function(d){var e,f,g,h,i=a(a(d.currentTarget).parents("li")[0]),j=0,k=Math.abs(b.parent().innerWidth()-b.parent().css("padding-left").replace(/px/,"")-b.parent().css("padding-right").replace(/px/,""));i.hasClass("open")?(b.find("li.details-container").attr("display","none").slideUp(250).delay(200).queue(function(){a(this).remove()}),b.find(".open").removeClass("open")):(b.find("li.details-container").attr("display","none").slideUp(250).delay(200).queue(function(){a(this).remove()}),b.find(".open").removeClass("open"),setTimeout(function(){i.addClass("open"),a.each(c,function(d,i){if(!g){var l=a(i).outerWidth();e||(e=a(i).hasClass("open"),f=d,h='<li class="col-xs-12 details-container"><div class="gallery"><span class="close"><button type="button" class="close">×</button></span>'+a(i).find(".content-gallery-details").html()+"</div></li>"),j+=l,(j>=k||d===c.length-1)&&(e?(a(i).after(h),b.find(".details-container").attr("display","block").slideDown(450),b.find(".details-container .close").on("click",function(c){c.preventDefault(),b.find("li.details-container").attr("display","none").slideUp(450).delay(500).queue(function(){a(this).remove()}),b.find(".open").removeClass("open")}),b.find(".details-container").on("click",function(a){a.stopPropagation()}),g=!0):j=0)}})},100))})};e()})}}(jQuery),function(a){a.dellUIuniversalFooter=function(b,c){var d=this;d.$el=a(b),d.el=b,d.$el.data("dellUIuniversalFooter",d)},a.dellUIuniversalFooter.defaultOptions={xsMax:750,smMin:751,smMax:975,mdMin:974,mdMax:1141,dosomething:""},a.fn.dellUIuniversalFooter=function(b){return b&&(a.dellUIuniversalFooter.defaultOptions=a.extend(a.dellUIuniversalFooter.defaultOptions,b)),this.each(function(){new a.dellUIuniversalFooter(this);var b=a.dellUIuniversalFooter.defaultOptions,c=function(){var c=a(window).width(),d={isXS:!1,isSM:!1,isMD:!1,isLG:!1};switch(!0){case c<b.xsMax:d.isXS=!0;break;case c>b.smMin&&c<b.smMax:d.isSM=!0;break;case c>b.mdMin&&c<b.mdMax:d.isMD=!0;break;default:d.isLG=!0}return d},d=function(){c().isXS?(a(".footer-gallery").css("display","none"),a(".gallery-shadow-section").css("display","none")):(a(".footer-gallery").css("display","block"),a(".gallery-shadow-section").css("display","block"))},e=function(){setTimeout(function(){a(".gallery-item").removeAttr("style");var b={highest:0,columns:a(".gallery-item")};b.columns.each(function(){var c=a(this).outerHeight();c>b.highest&&(b.highest=c)}),b.columns.height(b.highest)},800)},f=function(){b.datafile||(b.datafile="components/footer/footerData.json"),a.getJSON(b.datafile,function(b){var c=[];a.each(b,function(){var d=b;a.each(d.countries,function(a,b){var d=b;c.push("<li><a href='javascript;'>"+d.label+"</a></li>")})}),a(".country-names").append(c)})};f(),e(),d(),a(window).resize(function(){e(),d()})})}}(jQuery),angular.module("dellUiComponents").directive("toggle",["$rootScope","$timeout","$compile",function(a,b,c){return{restrict:"A",link:function(d,e,f,g){switch(f.toggle){case"popover":var h=function(){e.popover("hide"),e.blur()};"hover"===f.trigger?e.popover({trigger:"hover"}):(e.popover({trigger:"manual"}),e.on("click",function(){e.popover("toggle")}),e.on("shown.bs.popover",function(){e.next().off("click"),e.next().on("click",function(){e.focus()}),$('[data-dismiss="popover"]').on("click",function(){b(function(){e.blur()},300)}),e.off("blur"),e.on("blur",function(){b(function(){e.is(":focus")||h()},500)}),c(e.next().contents())(d)}),e.on("hidden.bs.popover",function(){e.on("click",function(){e.popover("show")})}));break;case"tooltip":e.tooltip(),e.on("click",function(){a.bp.isXS&&e.tooltip("show")}),e.on("mouseenter",function(){a.bp.isXS&&e.tooltip("hide")});break;case"offcanvas":e.on("click",function(a){a.preventDefault(),e.parents(".row-offcanvas").find(".tab-content").removeClass("active"),e.parents(".row-offcanvas").removeClass("active")});break;case"tab":e.on("click",function(a){a.preventDefault(),$(this).tab("show"),$(this).parents(".row-offcanvas").find(".tab-content").addClass("active"),$(this).parents(".row-offcanvas").addClass("active")});break;case"collapse":e.on("click",function(a){a.preventDefault()});break;case"load-more":var i=f.target,j=$(i+" li").size(),k=3;i||console.error('You must use data-target when using data-toggle="load-more". '),$(i+" li:lt("+k+")").show(),e.click(function(){k=j>=k+5?k+5:j,$(i+" li:lt("+k+")").fadeIn(1500),$(i+" li:visible").size()===j&&e.hide();var a=$(this);a.button("loading"),setTimeout(function(){a.button("reset")},1500)});break;case"list-truncated":var l=f.target;if(l||(l=e.prev()),$(l).find("li").length<=5)e.hide();else{var m=0,n=0;_.each($(l).find("li"),function(a,b){5>b&&(n+=$(a).height()),m+=$(a).height()}),$(l).height(n),e.on("click",function(){var a=n;e.hasClass("collapsed")&&(a=m),e.toggleClass("collapsed"),$(l).animate({height:a},{duration:300,specialEasing:{height:"swing"}})})}}}}}]),angular.module("dellUiComponents").directive("navTabs",function(){return{restrict:"C",link:function(a,b,c,d){var e=b.parent().width(),f=b.find("> li"),g=0;_.each(f,function(a,b){g=g+$(a).width()+1}),g>e&&b.dellUIoverflowTab({iconClasses:{left:"icon-ui-arrowleft",right:"icon-ui-arrowright"}})}}}),angular.module("dellUiComponents").directive("defaultFooter",function(){return{restrict:"C",link:function(a,b,c,d){var e={};c.datafile&&(e.datafile=c.datafile),$(window).resize&&b.dellUIuniversalFooter(e)}}}),angular.module("ui.bootstrap.carousel",["ui.bootstrap.transition"]).controller("CarouselController",["$scope","$timeout","$transition","$q",function(a,b,c,d){}]).directive("carousel",function(){return{}}).directive("slide",function(){return{}}),angular.module("dellUiComponents").directive("carousel",["$timeout",function(a){return{restrict:"C",link:function(a,b,c,d){b.carousel()}}}]).directive("carouselFilmstrip",["$timeout",function(a){return{restrict:"C",link:function(a,b,c,d){$(b).find(".carousel-inner").slick({dots:!0,infinite:!1,speed:300,slidesToShow:4,slidesToScroll:1,responsive:[{breakpoint:1024,settings:{slidesToShow:4,slidesToScroll:1,infinite:!0}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]})}}}]).directive("carouselFilmstripArrowOnly",["$timeout",function(a){return{restrict:"C",link:function(a,b,c,d){$(b).find(".carousel-inner").slick({dots:!1,infinite:!1,speed:300,slidesToShow:4,slidesToScroll:1,responsive:[{breakpoint:1024,settings:{slidesToShow:4,slidesToScroll:1,infinite:!1,dots:!1}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:1,infinite:!1,dots:!1}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1,infinite:!1,dots:!1}}]})}}}]).directive("slide",["$timeout",function(a){return{restrict:"A",link:function(a,b,c,d){b.on("click",function(a){a.preventDefault()}),b.carousel(c.slide)}}}]),angular.module("dellUiComponents").directive("msCheckbox",function(){return{restrict:"C",link:function(a,b,c){var d="undefined"!=typeof c.placeholder?c.placeholder:"Please select";b.multipleSelect({placeholder:d})}}}).directive("listTree",function(){return{restrict:"C",link:function(a,b,c){b.find(".checkbox input").on("click",function(){$(this).is(":checked")?$(this).parent().addClass("open"):$(this).parent().removeClass("open")})}}}).directive("emailCheck",function(){return{restrict:"C",link:function(a,b,c,d){b.on("blur",function(){var a=b.val(),d=/[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}/gim;a.match(d)?(b.parents(".form-group").removeClass("has-error"),b.tooltip("destroy")):(c.errorMessage||(c.errorMessage="Please input a valid email address!"),b.parents(".form-group").addClass("has-error"),b.tooltip({title:c.errorMessage}))})}}}).directive("showHidePassword",function(){return{restrict:"C",link:function(a,b,c,d){b.find(".checkbox input[type=checkbox]").on("click",function(){b.find(".checkbox input[type=checkbox]").is(":checked")?b.find("input[type=password]").attr("type","text"):b.find("input[type=text]").attr("type","password")})}}}).directive("phoneNumber",function(){return{restrict:"C",link:function(a,b,c,d){b.is("input")&&(b.attr("data-inputmask","'mask': '(999)-999-9999'"),b.inputmask())}}}).directive("phoneExtension",function(){return{restrict:"C",link:function(a,b,c,d){b.is("input")&&(c.inputmask||b.attr("data-inputmask","'mask': 'ext: (9999)'"),b.inputmask())}}}).directive("bsSlider",function(){return{restrict:"C",link:function(a,b,c,d){var e={};c.sliderLabel&&(e.formatter=function(a){return c.sliderLabel+a}),b.slider(e)}}}).directive("spinbox",function(){return{restrict:"C",link:function(a,b,c,d){$(".spinbox").each(function(a){var b=$(this);"vertical"===b.data("orient")?$(b).addClass("dpui-numberPicker spinbox-vert").html("<button class='spinbox-increase'>"+b.data("spinincrease")+"</button><input type='text' class='spinbox-input spinbox-input-vert' style='border-top: 0px solid #cfcfcf; border-bottom: 0px solid #cfcfcf;' value='"+b.data("spindefault")+"' name='"+b.data("spinname")+"'/><button class='spinbox-decrease'>"+b.data("spindecrease")+"</button>"):$(b).addClass("dpui-numberPicker").html("<button class='spinbox-decrease'>"+b.data("spindecrease")+"</button><input type='text' class='spinbox-input' style='border-left: 0px solid #cfcfcf; border-right: 0px solid #cfcfcf;' value='"+b.data("spindefault")+"' name='"+b.data("spinname")+"'/><button class='spinbox-increase'>"+b.data("spinincrease")+"</button>")}),$(".spinbox-increase").click(function(){var a=$(this);"vertical"===a.parent().data("orient")&&parseInt($(this).siblings("input").val())<a.parent().data("spinmax")?$(a).next().val(parseInt($(a).next().val())+a.parent().data("spinstep")):parseInt($(this).siblings("input").val())<a.parent().data("spinmax")&&$(a).prev().val(parseInt($(a).prev().val())+a.parent().data("spinstep"))}),$(".spinbox-decrease").click(function(){var a=$(this);"vertical"===a.parent().data("orient")&&parseInt($(this).siblings("input").val())>a.parent().data("spinmin")?$(a).prev().val(parseInt($(a).prev().val())-a.parent().data("spinstep")):parseInt($(this).siblings("input").val())>a.parent().data("spinmin")&&$(a).next().val(parseInt($(a).next().val())-a.parent().data("spinstep"))}),$(".spinbox-input").blur(function(){var a=$(this);parseInt($(this).val())>a.parent().data("spinmax")?$(this).val(a.parent().data("spinmax")):parseInt($(this).val())<a.parent().data("spinmin")&&$(this).val(a.parent().data("spinmin"))}),$(document).ready(function(){$(".spinbox-input").keypress(function(a){return a.charCode<48||a.charCode>57?!1:void 0})})}}}).directive("selectState",function(){var a='<option value="">{{ emptyName }}</option><option ng-repeat="state in states" value="{{state.code}}">   {{state[label]}}</option>';return{scope:!0,controller:["$scope","$element","$attrs","$transclude",function(a,b,c,d){switch(a.selectedState="",a.format=c.format,a.states=[{code:"AL",label:"Alabama",long_label:"AL - Alabama"},{code:"AK",label:"Alaska",long_label:"AK - Alaska"},{code:"AZ",label:"Arizona",long_label:"AZ - Arizona"},{code:"AR",label:"Arkansas",long_label:"AR - Arkansas"},{code:"CA",label:"California",long_label:"CA - California"},{code:"CO",label:"Colorado",long_label:"CO - Colorado"},{code:"CT",label:"Connecticut",long_label:"CT - Connecticut"},{code:"DE",label:"Delaware",long_label:"DE - Delaware"},{code:"DC",label:"District of Columbia",long_label:"DC - District of Columbia"},{code:"FL",label:"Florida",long_label:"FL - Florida"},{code:"GA",label:"Georgia",long_label:"GA - Georgia"},{code:"HI",label:"Hawaii",long_label:"HI - Hawaii"},{code:"ID",label:"Idaho",long_label:"ID - Idaho"},{code:"IL",label:"Illinois",long_label:"IL - Illinois"},{code:"IN",label:"Indiana",long_label:"IN - Indiana"},{code:"IA",label:"Iowa",long_label:"IA - Iowa"},{code:"KS",label:"Kansas",long_label:"KS - Kansas"},{code:"KY",label:"Kentucky",long_label:"KY - Kentucky"},{code:"LA",label:"Louisiana",long_label:"LA - Louisiana"},{code:"ME",label:"Maine",long_label:"ME - Maine"},{code:"MD",label:"Maryland",long_label:"MD - Maryland"},{code:"MA",label:"Massachusetts",long_label:"MA - Massachusetts"},{code:"MI",label:"Michigan",long_label:"MI - Michigan"},{code:"MN",label:"Minnesota",long_label:"MN - Minnesota"},{code:"MS",label:"Mississippi",long_label:"MS - Mississippi"},{code:"MO",label:"Missouri",long_label:"MO - Missouri"},{code:"MT",label:"Montana",long_label:"MT - Montana"},{code:"NE",label:"Nebraska",long_label:"NE - Nebraska"},{code:"NV",label:"Nevada",long_label:"NV - Nevada"},{code:"NH",label:"New Hampshire",long_label:"NH - New Hampshire"},{code:"NJ",label:"New Jersey",long_label:"NJ - New Jersey"},{code:"NM",label:"New Mexico",long_label:"NM - New Mexico"},{code:"NY",label:"New York",long_label:"NY - New York"},{code:"NC",label:"North Carolina",long_label:"NC - North Carolina"},{code:"ND",label:"North Dakota",long_label:"ND - North Dakota"},{code:"OH",label:"Ohio",long_label:"OH - Ohio"},{code:"OK",label:"Oklahoma",long_label:"OK - Oklahoma"},{code:"OR",label:"Oregon",long_label:"OR - Oregon"},{code:"PA",label:"Pennsylvania",long_label:"PA - Pennsylvania"},{code:"RI",label:"Rhode Island",long_label:"RI - Rhode Island"},{code:"SC",label:"South Carolina",long_label:"SC - South Carolina"},{code:"SD",label:"South Dakota",long_label:"SD - South Dakota"},{code:"TN",label:"Tennessee",long_label:"TN - Tennessee"},{code:"TX",label:"Texas",long_label:"TX - Texas"},{code:"UT",label:"Utah",long_label:"UT - Utah"},{code:"VA",label:"Virginia",long_label:"VA - Virginia"},{code:"WA",label:"Washington",long_label:"WA - Washington"},{code:"WV",label:"West Virginia",long_label:"WV - West Virginia"},{code:"WI",label:"Wisconsin",long_label:"WI - Wisconsin"},{code:"WY",label:"Wyoming",long_label:"WY - Wyoming"},{code:"AA",label:"Armed Forces-Americas",long_label:"AA - Armed Forces-Americas"},{code:"AE",label:"Armed Forces-Europe",long_label:"AE - Armed Forces-Europe"},{code:"AP",label:"Armed Forces-Pacific",long_label:"AP - Armed Forces-Pacific"}],c.format){case"short":a.label="code";break;case"both":a.label="long_label";break;default:a.label="label"}}],restrict:"AC",template:a,link:function(a,b,c,d){a.emptyName=c.emptyName||"State"}}}).directive("dateSelector",["$timeout",function(a){return{restrict:"C",link:function(b,c,d){var e,f=c.find("input"),g=c.find(".icon-small-calendar"),h=f.width(),i=f.offset(),j=$(window).width(),k=$(window).height(),l={icons:{time:"icon-small-clock",date:"icon-small-calendar",up:"glyphicon glyphicon-chevron-up",down:"glyphicon glyphicon-chevron-down",previous:"glyphicon glyphicon-chevron-left",next:"glyphicon glyphicon-chevron-right",today:"icon-small-software",clear:"icon-small-trash",close:"icon-ui-close"},keepOpen:!0,widgetPositioning:{horizontal:"right",vertical:"undefined"!=typeof d.position?d.position:"bottom"},format:"undefined"!=typeof d.format?d.format:"MM/DD/YYYY"};f.datetimepicker(l),f.on("dp.show",function(b){j=$(window).width(),k=$(window).height(),h=f.width(),i=f.offset(),e=c.find(".bootstrap-datetimepicker-widget"),i.left+h+215>j?(e.removeClass("pull-right"),e.addClass("pull-left")):(e.removeClass("pull-left"),e.addClass("pull-right")),i.top-window.pageYOffset+255>k?e.removeClass("bottom").addClass("top"):e.removeClass("bottom, top").addClass(l.widgetPositioning.vertical),e.find(".datepicker tr > td.day").on("click",function(){a(function(){f.data("DateTimePicker").hide()})})}),g.on("click",function(a){f.focus()})}}}]),angular.module("dellUiComponents").directive("pagination",function(){return{restrict:"C",link:function(a,b,c){$(".pagination").jqPagination({paged:function(a){}})}}}).directive("loadMore",function(){return{restrict:"C",link:function(a,b,c){var d={lazyLoad:"undefined"!=typeof c.lazyLoad?"true"===c.lazyLoad:!1,scrollTarget:"undefined"!=typeof c.scrollTarget?c.scrollTarget:window,fadeIn:"undefined"!=typeof c.fadeIn?"true"===c.fadeIn:!0,loadMoreButtonText:"undefined"!=typeof c.loadMoreButtonText?c.loadMoreButtonText:"Load more",loadMoreIncrement:"undefined"!=typeof c.loadMoreIncrement?parseInt(c.loadMoreIncrement):5};b.dellUIloadMore(d)}}}),angular.module("dellUiComponents").directive("interactiveProgressBar",["$timeout",function(a){return{restrict:"C",link:function(b,c,d,e){b.fakeAnimationValue=0,b.fakeAnimation=function(){b.fakeAnimationId=a(function(){b.fakeAnimationValue<100&&(b.fakeAnimationValue=b.fakeAnimationValue+1,b.fakeAnimationSteps=Math.round(b.fakeAnimationValue/20),b.stripeAnimate="active",b.fakeAnimation())},_.random(100,500))},b.pauseFakeAnimation=function(){a.cancel(b.fakeAnimationId),b.fakeAnimationId=void 0,b.stripeAnimate=""},b.resetFakeAnimation=function(){b.fakeAnimationValue=0,b.fakeAnimation(),b.stripeAnimate="active"}}}}]),angular.module("dellUiComponents").directive("equalizeHeight",["$timeout","$rootScope",function(a,b){return{restrict:"A",link:function(b,c,d,e){var f=d.equalizeHeight;f?a(function(){$(f).matchHeight({property:"min-height"})},500):console.error('equalize-height usage error. Must include css selector to identify objects to equalize. Example: cequalize-height=".classname"')}}}]),function(a,b){b.scope(".contact-drawer",function(){this.listen(".contact-drawer-cta","click",function(b){a(b.currentTarget).parent().toggleClass("open")})})}(jQuery,Eve),angular.module("dellUiComponents").directive("navAnchored",["$timeout",function(a){return{restrict:"CA",link:function(b,c,d,e){function f(){c.css("width",c.parent().width()+1).css("left",c.parent().offset().left+.5)}function g(){c.find("> li").removeClass("active")}f(),$(window).resize(function(){f()});var h=(new Waypoint.Sticky({element:c,stuckClass:"affix",wrapper:"nav-tabs-affix"}),c.find("> li > a[href^=#]")),i=!1,j=c.height()+5;h&&($(h).on("click",function(a){a.preventDefault();var b=$($(a.currentTarget).attr("href"));$("html, body").stop().animate({scrollTop:b.offset().top-j},900,"swing"),c.find("> li").hasClass("active")&&(g(),$(a.currentTarget).parent().addClass("active"),i=!0)}),_.each(h,function(b,c){var d=$($(b).attr("href"));new Waypoint.Inview({element:d,entered:function(b){"up"!==b||i?a(function(){i=!1},900):(g(),$("[href="+this.element.selector+"]").parent().addClass("active"))},exited:function(b){"down"!==b||i?a(function(){i=!1},900):(g(),$("[href="+this.element.selector+"]").parent().next().addClass("active"))}})}))}}}]),angular.module("dellUiComponents").directive("tableFixedHeader",["$timeout",function(a){return{restrict:"C",link:function(a,b,c,d){$(document).ready(function(){var a=$(".table-sort").DataTable({pagingType:"simple",language:{paginate:{next:'Next&nbsp;<span aria-hidden="true" class="icon-ui-arrowright"></span>',previous:'<span aria-hidden="true" class="icon-ui-arrowleft"></span>&nbsp;Previous'}}});new $.fn.dataTable.FixedHeader(a)})}}}]).directive("tableFixedColumn",["$timeout",function(a){return{restrict:"C",link:function(a,b,c,d){var e=$(".table-column").DataTable({scrollY:"300px",scrollX:!0,scrollCollapse:!0,paging:!1,oLanguage:{sSearch:'<i class="icon-small-magnifying-glass text-blue"></i>'}});e.columns().iterator("column",function(a,b){$(e.column(b).header()).append('<span class="sort-icon"/>')}),new $.fn.dataTable.FixedColumns(e),b.each(function(){var a=$(this),b=a.closest(".dataTables_wrapper").find("div[id$=_filter] label");b.addClass("hide-text");var c=a.closest(".dataTables_wrapper").find("div[id$=_filter] input");c.attr("placeholder","Search"),c.addClass("form-control col-xs-12 col-sm-4");var d=a.closest(".dataTables_wrapper").find("div[id$=_length] select");d.addClass("form-control")})}}}]).directive("responsiveDataTable",["$timeout",function(a){return{restrict:"C",link:function(a,b,c,d){var e=$("table.responsive-data-table").DataTable({dom:'C<"clear">lfrtip',displayLength:5,paging:!1,scrollY:"300px",scrollX:!0,oLanguage:{sSearch:'<i class="icon-small-magnifying-glass text-blue"></i>'}});e.columns().iterator("column",function(a,b){$(e.column(b).header()).append('<span class="sort-icon"/>')}),b.each(function(){var a=$(this),b=a.closest(".dataTables_wrapper").find("div[id$=_filter] label");b.addClass("hide-text");var c=a.closest(".dataTables_wrapper").find("div[id$=_filter] input");c.attr("placeholder","Search"),c.addClass("form-control col-xs-12 col-sm-4");var d=a.closest(".dataTables_wrapper").find("div[id$=_length] select");d.addClass("form-control")})}}}]).directive("tableComplex",["$timeout",function(a){return{restrict:"C",link:function(a,b,c,d){function e(a){return'<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;"><tr><td>Full name:</td><td>'+a.name+"</td></tr><tr><td>Extension number:</td><td>"+a.extn+"</td></tr><tr><td>Extra info:</td><td>And any further details here (images etc)...</td></tr></table>"}var f=$("table.table-complex").DataTable({ajax:"../components/tables/data.json",columns:[{className:"details-control",orderable:!1,data:null,defaultContent:""},{data:"name"},{data:"position"},{data:"office"},{data:"salary"}],order:[[1,"asc"]],dom:'C<"clear">lfrtip',displayLength:5,paging:!1,scrollY:"300px",scrollX:!0,oLanguage:{sSearch:'<i class="icon-small-magnifying-glass text-blue"></i>'}});f.columns().iterator("column",function(a,b){$(f.column(b).header()).append('<span class="sort-icon"/>')}),$(".table-complex tbody").on("click","td.details-control",function(){var a=$(this).closest("tr"),b=f.row(a);b.child.isShown()?(b.child.hide(),a.removeClass("shown")):(b.child(e(b.data())).show(),a.addClass("shown"))}),b.each(function(){var a=$(this),b=a.closest(".dataTables_wrapper").find("div[id$=_filter] label");b.addClass("hide-text");var c=a.closest(".dataTables_wrapper").find("div[id$=_filter] input");c.attr("placeholder","Search"),c.addClass("form-control col-xs-12 col-sm-4");var d=a.closest(".dataTables_wrapper").find("div[id$=_length] select");d.addClass("form-control")})}}}]).directive("responsiveDataItem",["$timeout",function(a){return{restrict:"C",link:function(a,b,c,d){$(document).ready(function(){$("table.responsive-data-table").DataTable({dom:'C<"clear">lfrtip',displayLength:5,paging:!1,scrollY:"300px",scrollX:!0})})}}}]),angular.module("dellUiComponents").directive("tableExpandableRow",["$timeout",function(a){return{restrict:"C",link:function(b,c,d,e){function f(a){var b=a.table().node(),c=$('tbody input[type="checkbox"]',b),d=$('tbody input[type="checkbox"]:checked',b),e=$('thead input[name="select_all"]',b).get(0);0===d.length?(e.checked=!1,"indeterminate"in e&&(e.indeterminate=!1)):d.length===c.length?(e.checked=!0,"indeterminate"in e&&(e.indeterminate=!1)):(e.checked=!0,"indeterminate"in e&&(e.indeterminate=!0))}function g(a){return'<row><div class="row"><div class="col-xs-12"><div class="col-xs-6 col-sm-3 visible-xs-block"><p class="text-gray-medium small">Company Name</p><p>'+a.Company_name+'</p></div><div class="col-xs-6 col-sm-3 visible-xs-block"><p class="text-gray-medium small">Solution ID</p><p><a href="javascript:;" class="btn-link">'+a.Solution_ID+'</a></p></div><div class="col-xs-6 col-sm-3 visible-xs-block"><p class="text-gray-medium small">List Price</p><p>'+a.List_price+'</p></div><div class="col-xs-6 col-sm-3 visible-xs-block"><p class="text-gray-medium small">Quote Number</p><p><a href="javascript:;" class="btn-link">'+a.Quote_number+'</a></p></div><div class="row"><div class="col-xs-12 visible-xs-block"><hr class="hr-gray top-offset-10"></div></div><div class="col-xs-12"><h3 class="text-blue">Account Details</h3></div><div class="col-xs-6 col-sm-3"><p class="text-gray-medium small">Contact Number</p><p>'+a.Contact_number+'</p></div><div class="col-xs-6 col-sm-3"><p class="text-gray-medium small">Extension</p><p>'+a.Extension+'</p></div><div class="col-xs-6 col-sm-3"><p class="text-gray-medium small">Customer Since</p><p>'+a.Customer_since+'</p></div><div class="col-xs-6 col-sm-3"><p class="text-gray-medium small">Location</p><p>'+a.Location+'</p></div><div class="col-xs-6 col-sm-3"><p class="text-gray-medium small">Owner</p><p><a href="javascript:;" class="btn-link">'+a.Owner+'</a></p></div><div class="col-xs-6 col-sm-3"><p class="text-gray-medium small">Last Edited</p><p>'+a.Last_edited+'</p></div><div class="col-xs-6 col-sm-3"><p class="text-gray-medium small">Customer Number</p><p><a href="javascript:;" class="btn-link">'+a.Customer_number+'</a></p></div></div></div><div class="row"><div class="col-xs-12"><hr class="hr-gray top-offset-10"></div></div><div class="row"><div class="col-xs-12"><h3 class="text-blue col-xs-12">Additional Notes</h3></div><div class="col-xs-12"><div class="col-xs-6"><p class="text-gray-medium small">Purchase Details</p><p>'+a.Purchase_details+'</p></div><div class="col-xs-6"><p class=" text-gray-medium small">Sales Notes</p><p>'+a.Sales_notes+"</p></div></div></div></row>"}function h(b){b.preventDefault(),a(function(){c.find("td.editable").attr("contenteditable",!0),
